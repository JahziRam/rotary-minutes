...
> = {
  ...
  treasuryPlan: { enabled: "treasuryEnabled", menuVisible: "treasuryMenuVisible" },
  actions: { enabled: "actionsEnabled", menuVisible: "actionsMenuVisible" },
  projects: { enabled: "projectsEnabled", menuVisible: "projectsMenuVisible" },
...
export const ROUTE_FEATURES: Record<string, keyof ClubFeatureSet> = {
  ...
  "/treasury/mandate-plan": "treasuryEnabled",
  "/actions": "actionsEnabled",
  "/projects": "projectsEnabled",
  "/my-work": "actionsEnabled",
  "/calendar": "calendarEnabled",
  "/my-account": "memberPortalEnabled",
  "/members/commissions": "actionsEnabled",
