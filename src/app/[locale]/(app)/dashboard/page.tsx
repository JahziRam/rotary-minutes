    ...
    <AppShellServer title={t("nav.dashboard")}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">{clubName}</p>
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 h-10 px-4 py-2 rounded-lg text-sm font-medium border border-gray-200 bg-white hover:bg-gray-50 text-gray-900 transition-all"
          >
