...
const FEATURE_MODULES: Array<{
  ...
  { enabled: "actionsEnabled", menuVisible: "actionsMenuVisible", label: "Actions / tâches", inNav: true },
  { enabled: "projectsEnabled", menuVisible: "projectsMenuVisible", label: "Projets", inNav: true },
